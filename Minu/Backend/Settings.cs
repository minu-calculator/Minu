...
namespace Minu.Backend
{
    public class Settings
    {
        ...
        public static void ApplyAccent()
        {
            ...
            try
            {
                Application.Current.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("/Minu;component/Metro/Themes/" + theme + ".xaml", UriKind.Relative) });
            }
            catch
            {
                Application.Current.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("/Minu;component/Metro/Themes/Blue.xaml", UriKind.Relative) });
            }
        }
        public static Accents ApplicationAccent = Accents.Blue;

        public static double ApplicationSizeWidth = 500;
        public static double ApplicationSizeHeight = 500;
